...
function sortPriceAscending(stock1, stock2) {
  return stock1.price - stock2.price;
}
function sortPriceDescending(stock1, stock2) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  if (pricing == 'low-to-high') {
    stockCopy.sort(sortPriceAscending);
  } else if (pricing == 'high-to-low') {
    stockCopy.sort(sortPriceDescending);
  }
  res.json({ stocks: stockCopy });
});

function sortGrowthAscending(stock1, stock2) {
  return stock1.growth - stock2.growth;
}
function sortGrowthDescending(stock1, stock2) {
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  if (growth == 'low-to-high') {
    stockCopy.sort(sortGrowthAscending);
  } else if (growth == 'high-to-low') {
    stockCopy.sort(sortGrowthDescending);
  }
  res.json({ stocks: stockCopy });
});
